    ...
    <View style={styles.screen}>
      ...
      >
        ...
        <View>
          ...
          <Text style={styles.text}>Likes: {crop.likes}</Text>
        </View>

        {/* 🌱 Lifecycle */}
        <TouchableOpacity
          style={styles.sectionHeader}
          onPress={() => toggleSection('lifecycle')}
        >
          <Text style={styles.sectionTitle}>Crop Lifecycle</Text>
          <Ionicons
            name={expandedSections.lifecycle ? 'chevron-up-outline' : 'chevron-down-outline'}
            size={20}
            color="#2E7D32"
          />
        </TouchableOpacity>
        ...
        >
          ...
          <Ionicons
            name={expandedSections.cultivation ? 'chevron-up-outline' : 'chevron-down-outline'}
            size={20}
            color="#2E7D32"
          />
        </TouchableOpacity>
        {expandedSections.cultivation && (
          <View style={styles.sectionContent}>
            {crop.cultivationtips ? (
              crop.cultivationtips.split('•').map((tip: string, i: React.Key | null | undefined) =>
                tip.trim() ? (
              ...
              <Text style={styles.text}>No cultivation tips available.</Text>
            )}
          </View>
        )}
        ...
        >
          ...
          <Ionicons
            name={expandedSections.uses ? 'chevron-up-outline' : 'chevron-down-outline'}
            size={20}
            color="#2E7D32"
          />
        </TouchableOpacity>
        {expandedSections.uses && (
          <View style={styles.sectionContent}>
            {crop.uses ? (
              crop.uses.split('•').map((use: string, i: React.Key | null | undefined) =>
                use.trim() ? (
                  <Text key={i} style={styles.text}>
                    • {use.trim()}
                  </Text>
              ...
              <Text style={styles.text}>No usage information available.</Text>
            )}
          </View>
        )}
        ...
        >
          ...
          <Ionicons
            name={expandedSections.diseases ? 'chevron-up-outline' : 'chevron-down-outline'}
            size={20}
            color="#2E7D32"
          />
        </TouchableOpacity>
        {expandedSections.diseases && (
          <View style={styles.sectionContent}>
            {crop.diseases ? (
              ...
              <Text style={styles.text}>No disease information available.</Text>
            )}
          </View>
        )}
        ...
        >
          ...
          <Ionicons
            name={expandedSections.pests ? 'chevron-up-outline' : 'chevron-down-outline'}
            size={20}
            color="#2E7D32"
          />
        </TouchableOpacity>
        {expandedSections.pests && (
          <View style={styles.sectionContent}>
            {crop.pests ? (
              ...
              <Text style={styles.text}>No pest information available.</Text>
            )}
          </View>
        )}
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  text: { fontSize: 16, lineHeight: 22, color: '#333', marginBottom: 5 },
  sectionHeader: {
    flexDirection: 'row',
  ...
  sectionTitle: { fontSize: 18, fontWeight: '600', color: '#1B5E20' },
  sectionContent: { borderRadius: 8, padding: 10, marginTop: 5 },
});
