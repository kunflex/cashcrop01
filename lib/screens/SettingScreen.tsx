...
const SettingScreen = () => {
  ...
  const handlePrivacyPolicy = () =>
    Alert.alert('Privacy Policy', 'Show privacy policy.');
  const handleTerms = () =>
    Alert.alert('Terms & Conditions', 'Show terms and conditions.');
  const handleAboutApp = () =>
    Alert.alert('About', 'This is CashRop app. Version 1.0.0');
